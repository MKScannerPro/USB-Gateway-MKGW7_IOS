...
static NSString *const fileName = @"MKCOServerParams.txt";

@interface MKCOServerParamsModel ()
...
@implementation MKCOServerParamsModel
...
- (BOOL)checkServerDataProtocol:(id <MKCOServerParamsProtocol>)protocol {
