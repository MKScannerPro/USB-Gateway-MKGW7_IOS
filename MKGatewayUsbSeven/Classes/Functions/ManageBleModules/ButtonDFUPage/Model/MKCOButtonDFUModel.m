...
@implementation MKCOButtonDFUModel
...
- (BOOL)startDfu {
    ...
    [MKCOMQTTInterface co_startBXPButtonDfuWithFirmwareUrl:self.firmwareUrl dataUrl:self.dataUrl bleMac:self.bleMac macAddress:[MKCODeviceModeManager shared].macAddress topic:[MKCODeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
