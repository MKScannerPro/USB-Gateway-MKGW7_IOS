//
//  MKCOManageBleDeviceSearchView.m
...
@interface MKCOManageBleDeviceSearchView ()<UIGestureRecognizerDelegate>
...
@implementation MKCOManageBleDeviceSearchView

- (void)dealloc{
    NSLog(@"MKCOManageBleDeviceSearchView销毁");
}
...
+ (void)showSearchName:(NSString *)name
    ...
    MKCOManageBleDeviceSearchView *view = [[MKCOManageBleDeviceSearchView alloc] init];
...
- (UIImageView *)signalIcon{
    if (!_signalIcon) {
        _signalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(offset_X,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _signalIcon.image = LOADICON(@"MKGatewayUsbSeven", @"MKCOManageBleDeviceSearchView", @"co_wifiSignalIcon.png");
    }
    return _signalIcon;
}
...
- (UIImageView *)graySignalIcon {
    if (!_graySignalIcon) {
        _graySignalIcon = [[UIImageView alloc] initWithFrame:CGRectMake(backViewWidth - offset_X - signalIconWidth,
                                                                    ...
                                                                    signalIconWidth,
                                                                    signalIconHeight)];
        _graySignalIcon.image = LOADICON(@"MKGatewayUsbSeven", @"MKCOManageBleDeviceSearchView", @"co_wifiGraySignalIcon.png");
    }
