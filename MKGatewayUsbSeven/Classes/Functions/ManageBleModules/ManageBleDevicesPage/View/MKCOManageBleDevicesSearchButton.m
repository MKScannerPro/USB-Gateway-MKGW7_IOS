//
//  MKCOManageBleDevicesSearchButton.m
...
@implementation MKCOManageBleDevicesSearchButtonModel
@end

@interface MKCOManageBleDevicesSearchButton ()
...
@implementation MKCOManageBleDevicesSearchButton
...
- (void)clearButtonPressed{
    ...
    if ([self.delegate respondsToSelector:@selector(co_scanSearchButtonClearMethod)]) {
        [self.delegate co_scanSearchButtonClearMethod];
    }
}

- (void)searchButtonPressed{
    if ([self.delegate respondsToSelector:@selector(co_scanSearchButtonMethod)]) {
        [self.delegate co_scanSearchButtonMethod];
    }
}

#pragma mark - setting
- (void)setDataModel:(MKCOManageBleDevicesSearchButtonModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCOManageBleDevicesSearchButtonModel.class]) {
        return;
    }
...
- (UIImageView *)searchIcon{
    if (!_searchIcon) {
        ...
        _searchIcon.image = LOADICON(@"MKGatewayUsbSeven", @"MKCOManageBleDevicesSearchButton", @"co_searchGrayIcon.png");
    }
    return _searchIcon;
}
...
- (UIButton *)clearButton{
    if (!_clearButton) {
        ...
        [_clearButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCOManageBleDevicesSearchButton", @"co_clearButtonIcon.png") forState:UIControlStateNormal];
