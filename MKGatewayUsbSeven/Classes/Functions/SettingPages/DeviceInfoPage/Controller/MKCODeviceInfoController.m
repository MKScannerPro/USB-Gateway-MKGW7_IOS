...
@interface MKCODeviceInfoController ()<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKCODeviceInfoModel *dataModel;

@end

@implementation MKCODeviceInfoController

- (void)dealloc {
    NSLog(@"MKCODeviceInfoController销毁");
}
...
- (MKCODeviceInfoModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCODeviceInfoModel alloc] init];
    }
    return _dataModel;
}
