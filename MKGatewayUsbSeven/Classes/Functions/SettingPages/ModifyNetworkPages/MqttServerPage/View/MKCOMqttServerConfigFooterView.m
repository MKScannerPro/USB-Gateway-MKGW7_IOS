//
//  MKCOMqttServerConfigFooterView.m
...
@implementation MKCOMqttServerConfigFooterViewModel
@end
...
@interface MKCOMqttServerConfigFooterView ()<UIScrollViewDelegate,
MKMQTTGeneralParamsViewDelegate,
MKMQTTUserCredentialsViewDelegate,
MKCOMqttServerSSLViewDelegate,
MKCOMqttServerSettingViewDelegate,
MKCOMqttServerLwtViewDelegate>
...
@property (nonatomic, strong)MKCOMqttServerSSLView *sslView;

@property (nonatomic, strong)MKCOMqttServerLwtView *lwtView;

@property (nonatomic, strong)MKCOMqttServerSettingView *settingView;

@property (nonatomic, assign)NSInteger index;

@end

@implementation MKCOMqttServerConfigFooterView
...
#pragma mark - MKCOMqttServerSSLViewDelegate
...
- (void)co_mqtt_sslParams_modifyDevice_textFieldValueChanged:(NSInteger)index value:(NSString *)value {
    ...
    if ([self.delegate respondsToSelector:@selector(co_mqtt_serverForDevice_textFieldValueChanged:textID:)]) {
        [self.delegate co_mqtt_serverForDevice_textFieldValueChanged:value textID:tempIndex];
    }
}

#pragma mark - MKCOMqttServerSettingViewDelegate
...
#pragma mark - MKCOMqttServerLwtViewDelegate
...
#pragma mark - setter
- (void)setDataModel:(MKCOMqttServerConfigFooterViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCOMqttServerConfigFooterViewModel.class]) {
        return;
    }
    ...
    MKCOMqttServerSSLViewModel *sslModel = [[MKCOMqttServerSSLViewModel alloc] init];
    ...
    MKCOMqttServerLwtViewModel *lwtModel = [[MKCOMqttServerLwtViewModel alloc] init];
...
- (MKCOMqttServerSSLView *)sslView {
    if (!_sslView) {
        _sslView = [[MKCOMqttServerSSLView alloc] init];
...
- (MKCOMqttServerLwtView *)lwtView {
    if (!_lwtView) {
        _lwtView = [[MKCOMqttServerLwtView alloc] init];
...
- (MKCOMqttServerSettingView *)settingView {
    if (!_settingView) {
        _settingView = [[MKCOMqttServerSettingView alloc] init];
