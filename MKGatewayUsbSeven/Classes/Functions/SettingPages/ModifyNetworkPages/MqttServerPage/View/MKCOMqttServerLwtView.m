...
@implementation MKCOMqttServerLwtViewModel
@end

@interface MKCOMqttServerLwtView ()
...
@implementation MKCOMqttServerLwtView
...
- (void)lwtButtonPressed {
    ...
    UIImage *lwtIcon = (self.lwtButton.selected ? LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchSelectedIcon.png") : LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchUnselectedIcon.png"));
...
- (void)retainButtonPressed {
    ...
    UIImage *retainIcon = (self.retainButton.selected ? LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchSelectedIcon.png") : LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchUnselectedIcon.png"));
...
#pragma mark - setter
- (void)setDataModel:(MKCOMqttServerLwtViewModel *)dataModel {
    _dataModel = nil;
    _dataModel = dataModel;
    if (!_dataModel || ![_dataModel isKindOfClass:MKCOMqttServerLwtViewModel.class]) {
        return;
    }
...
- (UIButton *)lwtButton {
    if (!_lwtButton) {
        ...
        [_lwtButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchUnselectedIcon.png") forState:UIControlStateNormal];
...
- (UIButton *)retainButton {
    if (!_retainButton) {
        ...
        [_retainButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCOMqttServerLwtView", @"co_switchUnselectedIcon.png") forState:UIControlStateNormal];
