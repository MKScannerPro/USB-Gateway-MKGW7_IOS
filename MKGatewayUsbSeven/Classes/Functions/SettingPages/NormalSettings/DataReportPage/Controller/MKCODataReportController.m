...
@interface MKCODataReportController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCODataReportModel *dataModel;

@end

@implementation MKCODataReportController

- (void)dealloc {
    NSLog(@"MKCODataReportController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCODataReportController", @"co_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCODataReportModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCODataReportModel alloc] init];
    }
    return _dataModel;
}
