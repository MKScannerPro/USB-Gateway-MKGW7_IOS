...
@interface MKCOCommunicateController ()

@property (nonatomic, strong)MKTextField *textField;

@property (nonatomic, strong)UILabel *noteLabel;

@property (nonatomic, strong)MKCOCommunicateModel *dataModel;

@end

@implementation MKCOCommunicateController

- (void)dealloc {
    NSLog(@"MKCOCommunicateController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCOCommunicateController", @"co_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCOCommunicateModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCOCommunicateModel alloc] init];
    }
    return _dataModel;
}
