...
@interface MKCOBleDeviceInfoModel ()
...
@implementation MKCOBleDeviceInfoModel
...
- (BOOL)readDeviceModel {
    __block BOOL success = NO;
    [MKCOInterface co_readDeviceModelWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readSoftware {
    __block BOOL success = NO;
    [MKCOInterface co_readSoftwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readFirmware {
    __block BOOL success = NO;
    [MKCOInterface co_readFirmwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readHardware {
    __block BOOL success = NO;
    [MKCOInterface co_readHardwareWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readManu {
    __block BOOL success = NO;
    [MKCOInterface co_readManufacturerWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)readMacAddress {
    __block BOOL success = NO;
    [MKCOInterface co_readMacAddressWithSucBlock:^(id  _Nonnull returnData) {
        success = YES;
