//
//  MKCODuplicateDataFilterController.m
...
@interface MKCODuplicateDataFilterController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKCODuplicateDataFilterModel *dataModel;

@end

@implementation MKCODuplicateDataFilterController

- (void)dealloc {
    NSLog(@"MKCODuplicateDataFilterController销毁");
}
...
- (void)loadSubViews {
    ...
    [self.rightButton setImage:LOADICON(@"MKGatewayUsbSeven", @"MKCODuplicateDataFilterController", @"co_saveIcon.png") forState:UIControlStateNormal];
...
- (MKCODuplicateDataFilterModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKCODuplicateDataFilterModel alloc] init];
    }
    return _dataModel;
}
