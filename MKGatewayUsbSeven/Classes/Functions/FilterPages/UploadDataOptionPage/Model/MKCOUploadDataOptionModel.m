...
@interface MKCOUploadDataOptionModel ()
...
@implementation MKCOUploadDataOptionModel
...
- (BOOL)readUploadDataOption {
    ...
    [MKCOMQTTInterface co_readUploadDataOptionWithMacAddress:[MKCODeviceModeManager shared].macAddress topic:[MKCODeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
...
- (BOOL)configUploadDataOption {
    __block BOOL success = NO;
    [MKCOMQTTInterface co_configUploadDataOption:self macAddress:[MKCODeviceModeManager shared].macAddress topic:[MKCODeviceModeManager shared].subscribedTopic sucBlock:^(id  _Nonnull returnData) {
        success = YES;
        dispatch_semaphore_signal(self.semaphore);
    } failedBlock:^(NSError * _Nonnull error) {
        dispatch_semaphore_signal(self.semaphore);
