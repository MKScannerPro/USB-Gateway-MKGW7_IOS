...
- (void)syncButtonPressed {
    ...
    [[MKNormalService share] addScannerProDevicesToCloud:uploadList isHome:[MKCOUserLoginManager shared].isHome token:self.token sucBlock:^(id returnData) {
