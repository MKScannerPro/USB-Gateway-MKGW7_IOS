...
@interface MKCOImportServerController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MKCOImportServerController

- (void)dealloc {
    NSLog(@"MKCOImportServerController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([self.delegate respondsToSelector:@selector(co_selectedServerParams:)]) {
        [self.delegate co_selectedServerParams:model.leftMsg];
    }
