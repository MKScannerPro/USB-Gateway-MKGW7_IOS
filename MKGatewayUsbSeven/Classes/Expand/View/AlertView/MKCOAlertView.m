...
@implementation MKCOAlertViewModel
@end

@interface MKCOAlertView ()
...
@implementation MKCOAlertView

- (void)dealloc {
    NSLog(@"MKCOAlertView销毁");
}
...
- (void)showWithModel:(MKCOAlertViewModel *)dataModel
    ...
    if (!dataModel || ![dataModel isKindOfClass:MKCOAlertViewModel.class]) {
        return;
    }
